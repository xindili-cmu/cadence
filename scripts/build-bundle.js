...
const GLOBALS = ['Logo', 'Button', 'Input', 'Icon', 'CategoryTag', 'CategoryTabs', 'SignalScore', 'NewsCard', 'CATEGORIES', 'CATEGORY_MAP', 'getCategory', 'catVars', 'catLabel', 'catShort', 'XCUTS'];
