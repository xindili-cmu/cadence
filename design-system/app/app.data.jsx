...
window.CD_DICT = {
  en: {
    ...
    'sub.privacy': 'Your email is used only for this weekly digest — nothing else. First issue arrives with the next edition; one-click unsubscribe at the bottom of every email.',
  ...
  zh: {
    ...
    'sub.privacy': '邮箱仅用于发送这份周报，不作他用；首封随下一期发出，每封底部均可一键退订。',
    'sub.channels': '也可关注',
    'sub.wechat': '微信公众号',
    'sub.xhs': '小红书',
