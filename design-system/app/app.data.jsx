...
window.CD_DICT = {
  en: {
    ...
    hotNow: 'Active themes', hotSub: 'Research themes several recent papers converge on', nSources: 'sources',
    ...
    weeklyTop: "This week's signals", weeklyTopSub: 'Top 5 · 7 days',
  ...
  zh: {
    ...
    signalScore: '信号分',
    ifTip: '期刊影响因子',
    hotNow: '活跃主题', hotSub: '近期多篇论文聚焦的研究主题', nSources: '个来源报道',
    ...
    weeklyTop: '本周信号', weeklyTopSub: '近 7 天 · 前 5',
    whyCats: '分类是怎么定的？',
