...
window.CD_DICT = {
  en: {
    'nav.curated': 'Curated', 'nav.all': 'All stories', 'nav.daily': 'Daily brief', 'nav.saved': 'Saved', 'nav.sources': 'Sources', 'nav.about': 'About', 'nav.feedback': 'Feedback',
    // Short labels for the mobile bottom tab bar (≤8 chars so the tabs fit at 320px)
    'navS.curated': 'Curated', 'navS.all': 'All', 'navS.daily': 'Daily', 'navS.saved': 'Saved', 'navS.sources': 'Sources', 'navS.about': 'About', 'navS.feedback': 'Feedback',
    ...
    'about.why.p1': "I studied physical therapy as an undergraduate and spent two years in the clinic after graduating. That was when I understood what a PT's day really looks like. Assessments, manual therapy, exercise prescription, charting, one patient after another, often without a minute to spare. By the time things slow down, there's no energy left to keep up with new research, guidelines, techniques, and where the field is heading.",
    'about.why.p2': "Later, life took an unexpected turn and I went back to school for a master's in data analytics. But my love for rehab never faded. Friends, classmates, even former teachers still come to me with rehab questions, and I can always help a little.",
    'about.why.p3': "With one foot in the field I couldn't let go of and one foot in a new skill set, the idea felt natural: what if I used data to automate the two or three hours I used to spend every day? And I realized it isn't only therapists drowning in the information stream. Rehab students, educators, and strength coaches all want to keep up, and all run into the same wall of time.",
    'about.why.p4': 'In June 2026, I built Cadence. It does those two or three hours of filtering for you, keeping only the signals worth your time. Whether you are a clinician, a rehab student or educator, or a strength coach, you can catch up with the whole field in a few minutes.',
    ...
    'about.contact.body': 'Have a suggestion, or a source worth adding? I read every note that comes in.',
  ...
  zh: {
    'nav.curated': '精选', 'nav.all': '全部', 'nav.daily': '每日简报', 'nav.saved': '收藏', 'nav.sources': '信源', 'nav.about': '关于', 'nav.feedback': '反馈',
    'navS.curated': '精选', 'navS.all': '全部', 'navS.daily': '简报', 'navS.saved': '收藏', 'navS.sources': '信源', 'navS.about': '关于', 'navS.feedback': '反馈',
    ...
    'about.why.p1': '我本科读的是物理治疗，毕业后做了两年临床。真正进了临床才发现，PT 的一天是被患者填满的。评估、徒手治疗、运动指导、写病历，一个接一个，常常连喝水的时间都没有。等终于喘口气，根本没精力再去追最新的研究、指南、新技术和行业动态。',
    'about.why.p2': '后来机缘巧合，我转行来读数据分析硕士。但我对康复的热爱一直没断，身边的朋友、同学，甚至老师，时不时还会来找我聊康复的问题，我也总能帮上一点忙。',
    'about.why.p3': '一边是放不下的专业，一边是新学的本事，我很自然地想：能不能用数据的方法，把我当年每天花两三个小时做的事自动化？而且我发现，被信息洪流淹没的不只是治疗师。康复方向的学生、老师、体能教练，每个人都想跟上最新进展，却都困在同样的时间里。',
    'about.why.p4': '2026 年 6 月，我做了步频。它替你完成每天那两三个小时的筛选，把最值得花时间的那几条信号留下来。无论你是临床治疗师、康复专业的师生，还是体能教练，都能用几分钟跟上整个领域的节奏。',
    ...
    'about.contact.body': '有建议，或想推荐值得收录的信源？每一条留言我都会看。',
