...
window.CD_DICT = {
  en: {
    ...
    yesterdaySignal: "Yesterday's signal", todaysSignal: "Today's Signal", categoryPulse: 'Category pulse · today',
  ...
  zh: {
    ...
    yesterdaySignal: '昨日信号', todaysSignal: '今日信号', categoryPulse: '分类脉搏 · 今天',
