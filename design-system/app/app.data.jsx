...
window.CD_DICT = {
  en: {
    ...
    'sub.curated': 'Ranked by evidence strength · updated daily', 'sub.all': 'Every story Cadence has curated — live feed plus full archive',
    ...
    'about.how.1': 'Every day, an automated crawl sweeps 56 sources for the latest research and industry news.',
    'about.how.2': 'An AI scoring model ranks each item by clinical relevance, evidence level, and cross-source coverage.',
    'about.how.3': 'An automated relevance filter screens out off-topic noise — and everything Cadence pushes to its channels is reviewed and sent by a human.',
    'about.why.title': 'Why we built this',
    'about.why.p1': 'We trained as physical therapists and spent years in the clinic, so we know firsthand that a PT’s day is filled end to end with patients — by the time it’s over, there is neither the energy nor an easy way to keep up with what’s being published around the world.',
    'about.why.p2': 'Later we moved into data, but never left rehab. We kept wondering: could data and AI carry the newest clinical evidence to the therapists who need it, automatically? It isn’t only therapists trapped behind the information gap — rehab students, educators, and strength coaches all face the same “how do I keep my knowledge current” problem.',
    'about.why.p3': 'In June 2026, we built Cadence. We cross the information gap and do the frontier-literature filtering for you, keeping only what can actually change a clinical prescription. Whether you’re a therapist, a rehab student or educator, or a strength coach, here you can catch up on the evidence that matters in a few minutes — and keep pace with the field.',
    ...
    'fb.send': 'Send it', 'fb.sending': 'Sending…', 'fb.sent': 'Sent — thank you. We read everything that comes in.',
    ...
    'intel.section': 'Industry & policy', 'intel.note': 'Not scored — SIGNAL rates research evidence only', 'intel.chip': 'Industry',
    ...
    'sub.error': 'Something went wrong — try again, or email hello@incadencept.com.',
    'sub.privacy': 'Your email is used only for this weekly digest — nothing else. First issue arrives with the next weekly send; one-click unsubscribe at the bottom of every email.',
    ...
    'daily.empty': 'No editions yet — the first one appears after the next morning crawl.',
  ...
  zh: {
    ...
    'sub.sources': '步频监测的信源', 'sub.about': '步频写给谁、怎么运作、为什么存在', 'sub.feedback': '一起决定步频接下来怎么走',
    // 关于页 — 品牌声明、工作原理、创始人故事、信源透明、免责声明、联系
    'about.brand': '步频是一个面向康复领域的每日循证信号聚合器，服务于物理治疗、康复与运动科学的从业者、师生和教练。我们从 JOSPT、PTJ、PubMed 及 56 个专业信源中筛选最值得花时间的研究与行业动态，每天早上准时更新。',
    'about.hero.lead': '每天替你筛掉噪音，只把最值得读的几条循证信号留下来。',
    'about.hero.sub': '面向物理治疗、康复与运动科学的从业者、师生和教练。',
    'about.how.title': '步频是怎么运作的',
    'about.how.1': '每天自动抓取 56 个信源的最新研究与行业动态。',
    'about.how.2': 'AI 评分模型按临床相关性、证据等级、多源交叉报道，对每条内容排序。',
    'about.how.3': '自动相关性过滤剔除无关噪音；所有对外推送的内容，都经人工审定后发出。',
    'about.why.title': '我们为什么做这个',
    'about.why.p1': '我们是物理治疗出身，做过几年临床。深知 PT 的一天是被患者填满的，忙完一天，根本没有精力和渠道去跨越语言和文献的壁垒，去追全球最新的行业动态。',
    'about.why.p2': '后来我们转去做数据，但一直没离开康复。我们常想：能不能用数据和 AI，把全球最新的临床证据自动化地搬运到国内治疗师的面前？被信息差困住的不只是治疗师，康复的学生、老师、体能教练，都面临着同样的“知识库更新”困境。',
    'about.why.p3': '2026 年 6 月，我们做了步频 Cadence。我们替你跨越信息差、做完前沿文献的筛选，只留真正能改变临床处方的干货。无论你是治疗师、康复师生还是体能教练，在这里，几分钟就能武装自己的知识库，跟上整个世界的步伐。',
    ...
    'fb.send': '发送', 'fb.sending': '发送中…', 'fb.sent': '已收到，谢谢。每一条我们都会看。',
    ...
    'sub.privacy': '邮箱仅用于发送这份周报，不作他用；首封随下一期周报发出，每封底部均可一键退订。',
    'sub.channels': '也可关注',
    'sub.wechat': '微信公众号',
    'sub.xhs': '小红书',
    'sparse.note': '这个专科目前收录还不多——我们正在扩充它的期刊来源。「全部」里有该科的全部历史收录。',
    'sparse.cta': '查看全部文章',
    'item.loading': '正在加载文章…',
    ...
    'kindFilter.all': '全部',
    today: '今天', yesterday: '昨天', older: '本周更早',
    ...
    'daily.archiveTitle': '历史日报', 'daily.eventsN': '篇',
...
window.ABOUT = {
  steps: [
    { idx: '01', demo: 'sources', zh: '采集', en: 'Ingest',
      bodyZh: '每天清晨，自动抓取 JOSPT、PTJ、BJSM、PubMed 等 56 个信源的新发表研究。',
      bodyEn: 'Each morning we pull newly published studies from JOSPT, PTJ, BJSM, PubMed and 56 sources in all.' },
    { idx: '02', demo: 'signal', zh: '评分', en: 'Score',
      bodyZh: 'AI 将每项发现评入三个证据强度档位——强信号、值得关注、参考——衡量它值得临床人关注的程度。评估综合研究设计、样本量、效应量与期刊影响力。',
      bodyEn: 'Our AI places each finding in one of three evidence-strength tiers — strong signal, worth knowing, for reference — weighing study design, sample size, effect size and journal impact.' },
